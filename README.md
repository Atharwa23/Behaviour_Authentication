...
**Example Test Output:**
```
Sample #1: Predicted = Genuine (Confidence: 95.2%)
Sample #2: Predicted = Genuine (Confidence: 94.8%)
Sample #3: Predicted = Imposter (Confidence: 87.3%)
```
...
| `test/keystroke_predictions.csv` | Model predictions on test data |
...
**Solutions**:
- Collect more genuine samples (10-20+ recommended)
